...
ax.plot(re800_avg6_value, re800_avg6_y_mod, color=color_set[5], label='Lagrange Re800', linestyle='-',linewidth=l_w_1)

ax.plot(avg3_value, avg3_y_mod, color=color_set[1], label='Eulerian Re200', linestyle='--',linewidth=l_w_1)
ax.plot(avg6_value, avg6_y_mod, color=color_set[5], label='Lagrange Re200', linestyle='--',linewidth=l_w_1)
